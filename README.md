...
repository contains the starter for Lab 12 in Computer Science 203. Since the
...
repository will related to the fact that they may not exist or that they do
not pass the linting checks of the two linters.
...
```
git remote add download git@github.com:Allegheny-Computer-Science-203-S2019/cs203-S2019-lab12-starter.git
```
...
you can go to the [Computer Science 203 Lab 12
Starter](https://github.com/Allegheny-Computer-Science-203-S2019/cs203-S2019-lab12-starter)
